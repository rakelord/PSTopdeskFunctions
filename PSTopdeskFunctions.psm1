...
Function Get-TopdeskBranch {
    ...
    if (Find-TopdeskConnection) {
        $Uri = "$topdeskUrl/tas/api/branches?query=name=='$BranchName'" + '&$fields=name,status,id,creationDate,modificationDate,optionalFields1,optionalFields2'
...
Function Get-TopdeskBranches {
    ...
    if (Find-TopdeskConnection) {
        $Uri = "$topdeskUrl/tas/api/branches?" + '$fields=name,status,id,creationDate,modificationDate,optionalFields1,optionalFields2'
